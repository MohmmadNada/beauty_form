...
class SignUpForm {
  constructor() {
    ...
    // new InputComponent(formElement, "email");
    new EmailComponent();
    new InputComponent(formElement, "username");
    new InputComponent(formElement, "password-1");
    new InputComponent(formElement, "password-2");
...
const firstPasswordInput = document.getElementById("password-1");
firstPasswordInput.addEventListener("input", isValidPassword);
const secondPasswordInput = document.getElementById("password-2");
secondPasswordInput.addEventListener("input", isPasswordMatch);
...
function isValidPassword() {
  ...
  if (/[A-Z]/.test(firstPassword.value) && /[a-z]/.test(firstPassword.value)) {
